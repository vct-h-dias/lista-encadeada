...
typedef struct{//representa��o da lista
    ...
    node_aluno *end;    //ponteiro para o �ltimo n� da lista
...
void insert_aluno(Lista *lista, int mat, char nome[], float nota, float frequencia, char turma){
    ...
    if(lista -> begin == NULL){
        ...
        //caso o inicio seja nulo n�o existem n�s
...
void remove_aluno(Lista *lista, int mat){
    ...
    //a cada la�o, ambos os n�s (after e before) avan�a
...
int main()
{
    ...
    do
    {
        ...
        case 5:
            ...
            //caso o contador for 0, n�o alunos daquela turma
            if(cont==0){
